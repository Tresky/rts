...
#include "../../inc/tile_engine/smart_camera.h"
...
SmartCamera::SmartCamera(const float _width, const float _height)
  ...
  , tracked_up(sf::Keyboard::S)
  , tracked_down(sf::Keyboard::W)
  , tracked_left(sf::Keyboard::D)
  , tracked_right(sf::Keyboard::A)
  , tracked_button(sf::Mouse::Left)
{}
...
///////////////////////////////////////////////////////////
void SmartCamera::SetTrackedKeys(const sf::Keyboard::Key _up, const sf::Keyboard::Key _down, const sf::Keyboard::Key _left, const sf::Keyboard::Key _right)
{
  tracked_up = _up;
  tracked_down = _down;
  tracked_left = _left;
...
///////////////////////////////////////////////////////////
void SmartCamera::SetTrackedMouseButton(sf::Mouse::Button _button)
{
