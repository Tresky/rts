...
#include "../../inc/tile_engine/object.h"
...
{
	if (object_type == priv::SF_OBJECT_TYPE_UNKNOWN)
		return "unknown";
	else if (object_type == priv::SF_OBJECT_TYPE_TILE)
		return "tile";
	else if (object_type == priv::SF_OBJECT_TYPE_ELLIPSE)
		return "ellipse";
	else if (object_type == priv::SF_OBJECT_TYPE_POLYGON)
		return "polygon";
	else if (object_type == priv::SF_OBJECT_TYPE_POLYLINE)
		return "polyline";
	else if (object_type == priv::SF_OBJECT_TYPE_IMAGE)
		return "image";
	else
		return "null";
}
